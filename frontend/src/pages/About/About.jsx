...
const About = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      title: "Reliability",
      description:
        "We pride ourselves on punctuality and consistent service delivery across all routes.",
    },
    {
      icon: FaHeart,
      title: "Customer Care",
        ...
        <div className="w-full lg:px-28 md:px-16 sm:px-7 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-violet-100 leading-relaxed">
              Connecting Nigeria, one journey at a time. We've been making
              travel safe, comfortable, and affordable for over 15 years.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-neutral-600 dark:text-neutral-400 leading-relaxed">
              Founded in 2008 with a simple mission: to make intercity travel in
              Nigeria safe, comfortable, and accessible to everyone.
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-6">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed">
                What started as a small transport company with just 3 buses has
                grown into Nigeria's most trusted intercity bus service. We
                began our journey connecting Lagos and Ibadan, and today we
                serve over 500 routes across all 36 states of Nigeria.
              </p>
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed">
                Our commitment to excellence, safety, and customer satisfaction
                has earned us the trust of over 50,000 passengers who choose us
                for their travel needs every month.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 lg:order-2">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed">
                ...
                with air conditioning, comfortable seating, and safety features.
                We've invested heavily in technology to provide you with
                real-time tracking, online booking, and 24/7 customer support.
              </p>
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed">
        ...
        <div className="w-full lg:px-28 md:px-16 sm:px-7 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-white dark:bg-neutral-900/60 rounded-2xl p-8 shadow-lg border border-neutral-200/50 dark:border-neutral-800/50 text-center hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
      ...
      <div className="w-full lg:px-28 md:px-16 sm:px-7 px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-neutral-600 dark:text-neutral-400 leading-relaxed mb-8">
            ...
            that connect communities across Nigeria, making travel accessible
