...
import { FaMapMarkerAlt, FaClock, FaArrowRight, FaFilter, FaSearch } from 'react-icons/fa';
import { allRoutes, formatNairaPrice } from '../../data/nigerianBusData';
        ...
        <div className="w-full lg:px-28 md:px-16 sm:px-7 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-green-100 leading-relaxed">
              Discover all destinations served by NaijaBus Express across Nigeria
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-neutral-900/80 rounded-2xl shadow-2xl border border-neutral-200/50 dark:border-neutral-800/50 p-8">
          ...
          <div className="mt-6 pt-6 border-t border-neutral-200 dark:border-neutral-700">
            <p className="text-neutral-600 dark:text-neutral-400">
              Showing <span className="font-semibold text-green-600 dark:text-green-400">{filteredRoutes.length}</span> routes
            </p>
          </div>
        </div>
      </div>
