  ...
  return (
    <div className="w-full min-h-screen lg:ps-28 md:ps-16 sm:ps-7 ps-4 mt-20 flex items-center justify-center flex-col hero relative overflow-hidden">
      ...
      <div className="flex-1 w-full flex items-stretch justify-between gap-12 pb-10 relative z-10">
        <motion.div
          className="w-[45%] h-auto rounded-md flex justify-center flex-col space-y-8 relative z-10"
        ...
        >
          ...
          >
            <motion.div
              className="inline-flex items-center gap-2 bg-violet-500/20 backdrop-blur-sm border border-violet-300/30 rounded-full px-4 py-2 text-violet-200 text-sm font-medium"
            ...
            <motion.h1
              className="text-6xl lg:text-7xl font-bold text-white leading-[1.1] drop-shadow-2xl"
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.p
              className="text-xl font-normal text-neutral-200 leading-relaxed max-w-lg drop-shadow-md"
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 2, ease: "linear", delay: 0.6 }}
            >
              Experience comfortable, safe, and affordable travel with our
              premium bus services. Book instantly and travel with confidence.
            </motion.p>
          </motion.div>
          ...
          >
            <Link
              to="/bus"
              className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-violet-600 to-violet-800 hover:from-violet-700 hover:to-violet-900 text-white font-semibold py-4 px-8 rounded-xl ease-in-out duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all"
            >
              <span>Book Now</span>
