  ...
  const offers = [
    {
      ...
      codeStyle:
        "border-violet-300 dark:border-violet-600 bg-violet-100 dark:bg-violet-800/20 text-violet-700 dark:text-violet-300",
      buttonStyle:
        "text-violet-600 hover:text-violet-700 dark:hover:text-violet-400 hover:bg-violet-100 dark:hover:bg-violet-800/20",
      icon: FaGift,
    },
    {
      id: 2,
      ...
      codeStyle:
        "border-blue-300 dark:border-blue-600 bg-blue-100 dark:bg-blue-800/20 text-blue-700 dark:text-blue-300",
      buttonStyle:
        "text-blue-600 hover:text-blue-700 dark:hover:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-800/20",
      icon: FaPercent,
    },
  ];
    ...
    <div className="w-full lg:px-28 md:px-16 sm:px-7 px-4 py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {offers.map((offer) => (
          <div
            key={offer.id}
            className={`w-full h-auto rounded-2xl bg-gradient-to-br ${offer.gradient} p-8 flex items-center gap-x-6 shadow-xl border ${offer.borderColor} hover:shadow-2xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden`}
          >
            ...
            <div className="relative z-10 flex items-center gap-6 w-full">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="flex items-center gap-x-4">
                  <div
                    className={`w-fit border-2 border-dashed px-4 py-2 ${offer.codeStyle} rounded-lg font-mono font-bold text-sm`}
                  >
                    {copied[offer.code] ? (
