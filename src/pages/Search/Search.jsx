...
import { FaSearch, FaMapMarkerAlt, FaCalendarAlt, FaClock, FaUsers } from "react-icons/fa";
    ...
    <div className="w-full lg:px-28 md:px-16 sm:px-7 px-4 -mt-16 relative z-20">
      <div className="w-full bg-white dark:bg-neutral-900 rounded-2xl p-8 shadow-2xl border border-neutral-200/50 dark:border-neutral-800/50 backdrop-blur-sm">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 items-end">
            <div className="lg:col-span-1">
              <label htmlFor="from" className="flex items-center gap-2 mb-3 font-semibold text-neutral-700 dark:text-neutral-300">
            ...
            <div className="lg:col-span-1">
              <label htmlFor="to" className="flex items-center gap-2 mb-3 font-semibold text-neutral-700 dark:text-neutral-300">
                <FaMapMarkerAlt className="text-violet-600 text-sm" />
                To
              </label>
              <select
            ...
            <div className="lg:col-span-1">
              <label htmlFor="date" className="flex items-center gap-2 mb-3 font-semibold text-neutral-700 dark:text-neutral-300">
            ...
            <div className="lg:col-span-1">
              <label htmlFor="time" className="flex items-center gap-2 mb-3 font-semibold text-neutral-700 dark:text-neutral-300">
            ...
            <div className="lg:col-span-1">
              <label htmlFor="seat" className="flex items-center gap-2 mb-3 font-semibold text-neutral-700 dark:text-neutral-300">
        ...
        <div className="mt-8 pt-6 border-t border-neutral-200 dark:border-neutral-700">
          <p className="text-sm font-medium text-neutral-600 dark:text-neutral-400 mb-4">Popular Routes:</p>
            ...
            {[
              ...
              <button
                ...
                onClick={() => {
                  ...
                  setForm(prev => ({ ...prev, from: from + ', NY', to: to + ', FL' }));
                }}
              >
                {route}
              </button>
