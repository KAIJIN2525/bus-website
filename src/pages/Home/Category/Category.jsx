  ...
  return (
    <div className='w-full lg:px-28 md:px-16 sm:px-7 px-4 py-16 bg-neutral-50 dark:bg-neutral-900/30'>
      <div className="w-full items-center flex justify-between mb-12">
        ...
        <Link to={"/bus"} className='hidden md:flex items-center gap-3 text-violet-600 hover:text-violet-700 dark:hover:text-violet-400 font-semibold transition-all duration-300 group bg-violet-50 dark:bg-violet-900/20 px-6 py-3 rounded-xl hover:bg-violet-100 dark:hover:bg-violet-900/30'>
          View All Buses
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {categories.map((category, index) => (
          ...
          >
            ...
            <div className={`absolute top-0 left-0 w-full h-full bg-gradient-to-tr ${category.gradient} group-hover:flex hidden items-center justify-center ease-in-out duration-500 backdrop-blur-sm`}>
      ...
      <div className="md:hidden mt-8 text-center">
        <Link to={"/bus"} className='inline-flex items-center gap-3 text-violet-600 hover:text-violet-700 dark:hover:text-violet-400 font-semibold transition-all duration-300 group bg-violet-50 dark:bg-violet-900/20 px-6 py-3 rounded-xl hover:bg-violet-100 dark:hover:bg-violet-900/30'>
          View All Buses
          <FaArrowRight className="text-sm transform group-hover:translate-x-1 transition-transform duration-300" />
        </Link>
      </div>
